...
The first five structured mission drafts are in `data/volume_auction_missions_en-US.json`. They are not yet canonical or published.
...
Review the first five structured drafts, author matching English mission markdown, and add illustration specifications before integrating them into the canonical dataset.
